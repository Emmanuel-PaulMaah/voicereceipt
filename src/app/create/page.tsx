    ...
    <AppShell>
      {!businessProfile?.businessName ? (
        <div className="mx-auto max-w-2xl rounded-3xl border border-amber-200 bg-amber-50 p-6 text-center">
          ...
          <h1 className="mt-4 text-2xl font-black tracking-tight text-amber-950">
            Set up your business profile first.
          </h1>

          <p className="mt-2 text-sm leading-6 text-amber-800">
            Save your business name once so you do not need to type it for every
            receipt.
          </p>

          <Link
            href="/settings"
            className="mt-5 inline-flex rounded-2xl bg-zinc-950 px-5 py-4 text-sm font-black text-white hover:bg-zinc-800"
          >
            Open settings
          </Link>
        </div>
              ...
              <div className="flex min-h-[520px] w-full max-w-md items-center justify-center rounded-3xl border border-dashed border-zinc-300 bg-white p-8 text-center">
                <div>
                  ...
                  <p className="mt-3 text-sm leading-6 text-zinc-500">
                    Your receipt preview will update before you generate the
                    final saved receipt.
                  </p>
                </div>
              </div>
